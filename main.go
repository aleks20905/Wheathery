...
import (
	...
	_ "github.com/aleks20905/wheathery/backend"
	_ "github.com/aleks20905/wheathery/frontend"
	"github.com/aleks20905/wheathery/iface"
)
...
func main() {
	...
	if err := confy.Parse("wheathery"); err != nil {
